...
public class Main extends JFrame {
	 ...
	 * 滚动条自动滚到底部
	 */
	public static void scrollAndSetCursor() {
		// ta.requestFocus();
	 ...
	 */
	public Main() {
		setTitle("溢油数据中心模拟客户端");
		//setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.addWindowListener(new CloseHandler(sessions) );
		...
		txt_IPAddr.setText("172.27.62.116");
		...
		JRadioButton r_DTU = new JRadioButton("DTU");
		...
		button_Connect.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<String> imei_collection = CommonUtil.generalIMEI(c_Count,
						type);
...
class CloseHandler extends WindowAdapter{
	...
	public CloseHandler(Map<String, IoSession> sessions) {
