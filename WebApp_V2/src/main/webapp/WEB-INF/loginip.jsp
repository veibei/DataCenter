...
<!-- userJs -->
<script type="text/javascript" src="js/userPageFunction/userPage.js"></script>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-list"></i>DTU终端连接情况
								</h2>
							...
							<div class="box-content buttons" style="min-height: 550px ;height:auto">
										...
										<div id="DataTables_Table_0_length" class="dataTables_length">
											<label> 每页&nbsp<select id="perPageCountSelect" name="DataTables_Table_0_length"
												size="1" aria-controls="DataTables_Table_0"  onchange="changePerPage();">
													...
													<option value="10"  <s:if test="#session.perPageCountlogInIp==10">selected="selected"</s:if> >10</option>
													<option value="25" <s:if test="#session.perPageCountlogInIp==25">selected="selected"</s:if>>25</option>
													<option value="50" <s:if test="#session.perPageCountlogInIp==50">selected="selected"</s:if>>50</option>
													<option value="100" <s:if test="#session.perPageCountlogInIp==100">selected="selected"</s:if>>100</option>
											</select> 条记录
											</label>
										</div>
									</div>
								...
								<table
									...
									<tbody>
										 ...
										 <s:iterator value="#session.pagelogInIp" id="logInIp" status="st">
											<tr>
												<td class="center"><s:property value="#logInIp.logTime" /></td>
												<td class="center"><s:property value="#logInIp.ip" /></td>
								...
								<s:property value="#session.rowsCountlogInIp" />
								条记录&nbsp 共
								<s:property value="#session.pageCountlogInIp" />
								页
								<ul class="pagination pagination-centered">
									<!-- 显示前一页页按钮 -->
									<s:if test="#session.currentPagelogInIp>1">
										<li><a href="userSubPage?pageIndexlogInIp=<s:property	value="#session.currentPagelogInIp-1" />">前一页</a></li>
									</s:if>
									<s:iterator value="#session.listBtnlogInIp" id="value" status="st">
										<s:if test="#value==#session.currentPagelogInIp">
											<li class="active"> <a href="userSubPage?pageIndexlogInIp=<s:property	value="#value" />"><s:property	value="#value" /></a></li>	
										</s:if>
											
										<s:else>
											<li><a href="userSubPage?pageIndexlogInIp=<s:property	value="#value" />"><s:property value="#value" /></a></li>
										</s:else>
									...
									<!-- 显示后一页按钮 -->
									<s:if test="#session.currentPagelogInIp<#session.pageCountlogInIp">
										<li><a href="userSubPage?pageIndexlogInIp=<s:property	value="#session.currentPagelogInIp+1" />">后一页</a></li>
									</s:if>
