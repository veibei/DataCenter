...
<script src="js/rateAnalysisFunction/loadFunction.js"></script>
<script src="js/echarts/commonRadar.js"></script>
</head>
...
<body>
	...
	<div class="ch-container">
		<div class="row">
			<a class="btn btn-default" onclick="requestData();"
				...
				<div class="row">
					...
					<div class="box col-md-6">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-list"></i>客户端上行流量分布
								</h2>
							...
							<div class="box-content buttons"
								...
								<div id="clientUp" style="width: 100%; height: 540px"></div>
					...
					<div class="box col-md-6">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-list"></i>客户端下行流量分布
								</h2>
							...
							<div class="box-content buttons"
								...
								<div id="clientDown" style="width: 100%; height: 540px"></div>
				...
				<div class="row">
					...
					<div class="box col-md-6">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-list"></i>DTU上行流量分布
								</h2>
							...
							<div class="box-content buttons"
								...
								<div id="DTUUp" style="width: 100%; height: 540px"></div>
					...
					<div class="box col-md-6">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-list"></i>DTU下行流量分布
								</h2>
							...
							<div class="box-content buttons"
								...
								<div id="DTUDown" style="width: 100%; height: 540px"></div>
