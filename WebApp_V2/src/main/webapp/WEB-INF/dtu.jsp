							...
							<div class="box-content buttons" style="min-height: 550px ;height:auto">
										...
										<div id="DataTables_Table_0_length" class="dataTables_length">
											<label> 每页&nbsp<select id="perPageCountSelect" name="DataTables_Table_0_length"
												size="1" aria-controls="DataTables_Table_0"  onchange="changePerPage();">
													...
													<option value="10"  <s:if test="#session.perPageCountDTU==10">selected="selected"</s:if> >10</option>
													<option value="25" <s:if test="#session.perPageCountDTU==25">selected="selected"</s:if>>25</option>
													<option value="50" <s:if test="#session.perPageCountDTU==50">selected="selected"</s:if>>50</option>
													<option value="100" <s:if test="#session.perPageCountDTU==100">selected="selected"</s:if>>100</option>
											</select> 条记录
											</label>
										</div>
									</div>
								...
								<table
									...
									<tbody>
										 ...
										 <s:iterator value="#session.pageDTU" id="dtu" status="st">
											<tr>
												<td class="center"><s:property value="#dtu.IMEI" /></td>
												<td class="center"><s:property value="#dtu.IP" /></td>
												<td class="center"><s:property value="#dtu.down" /></td>
												<td class="center"><s:property value="#dtu.up" /></td>
												<td class="center"><span
													class="label-success label label-default"><s:property
															value="#dtu.status" /></span></td>
											</tr>
								...
								<s:property value="#session.rowsCountDTU" />
								条记录&nbsp 共
								<s:property value="#session.pageCountDTU" />
								页
								<ul class="pagination pagination-centered">
									<!-- 显示前一页页按钮 -->
									<s:if test="#session.currentPageDTU>1">
										<li><a href="dtuSubPage?pageIndexDTU=<s:property	value="#session.currentPageDTU-1" />">前一页</a></li>
									</s:if>
									<s:iterator value="#session.listBtnDTU" id="value" status="st">
										<s:if test="#value==#session.currentPageDTU">
											<li class="active"> <a href="dtuSubPage?pageIndexDTU=<s:property	value="#value" />"><s:property	value="#value" /></a></li>	
										</s:if>
											
										<s:else>
											<li><a href="dtuSubPage?pageIndexDTU=<s:property	value="#value" />"><s:property value="#value" /></a></li>
										</s:else>
									...
									<!-- 显示后一页按钮 -->
									<s:if test="#session.currentPageDTU<#session.pageCountDTU">
										<li><a href="dtuSubPage?pageIndexDTU=<s:property	value="#session.currentPageDTU+1" />">后一页</a></li>
									</s:if>
