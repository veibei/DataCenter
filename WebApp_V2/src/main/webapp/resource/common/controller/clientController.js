 ...
 */
'use strict'
angular.module("dtucenter").controller('clientController', ['$scope', '$rootScope', 'clientService', function ($scope, $rootScope, clientService) {
    //更新url 为左侧导航栏添加标识
    $rootScope.url = "client";
    /**
     * 更改每页的记录数量
     * @param x
     */
    $scope.changePerPage=function (x) {
        clientService.changePerPageCount({
            perPageCount:x,
